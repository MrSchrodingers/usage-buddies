...
install_collector() {
    ...
    cp "$REPO_DIR/scripts/buddy_voice.py" "$HOME/.local/bin/" \
    ...
    cp "$REPO_DIR/scripts/buddy_actions.py" "$HOME/.local/bin/" \
        || warn "Failed to copy buddy_actions.py" "The companion will not start"
    cp "$REPO_DIR/scripts/buddy_peers.py" "$HOME/.local/bin/" \
        || warn "Failed to copy buddy_peers.py" "The companion will not start"
    cp "$REPO_DIR/scripts/buddy_hoop.py" "$HOME/.local/bin/" \
        || warn "Failed to copy buddy_hoop.py" "The companion will not start"
    cp "$REPO_DIR/scripts/buddy_idle.py" "$HOME/.local/bin/" \
        || warn "Failed to copy buddy_idle.py" "The companion will not start"
    cp "$REPO_DIR/scripts/buddy_target.py" "$HOME/.local/bin/" \
        || warn "Failed to copy buddy_target.py" "The companion will not start"
